...
def sort_products(
    ...
    if sort_by not in valid_sort_fields:
        return {"error": f"Invalid sort_by. Allowed: {valid_sort_fields}"}
...
def sort_by_category():
    ...
    sorted_products = sorted(
        products,
        key=lambda p: (p["category"], p["price"])  # 🔥 multi-level sorting
    )
...
def search_orders(customer_name: str = Query(...)):
    ...
    for o in orders:
        name = o.get("customer_name") or o.get("company")  # ✅ safe access
